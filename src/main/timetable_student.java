...
public class timetable_student {
	...
	public static HashMap<String, Classes> Time_tut = new HashMap<>();
	public static HashMap<String, Classes> Time_lab = new HashMap<>();
	public static void generate(){
		if(Student.listofcourses.containsKey("CSE201")){
			...
			Time_tut.put("CSE201", new Classes("CSE201","LR1,LR2,S01,S02","12:00-1:00","","","",""));
			Time_tut.put("CSE201", new Classes("CSE201","L21,L22,L23","","","","12:00-1:00",""));


		}
		if(Student.listofcourses.containsKey("CSE121")){
			Time_Table.put("CSE121", new Classes("CSE121", "C21", " ","1:30-3:00"," ", " ", "11:30-1:00"));
			Time_tut.put("CSE121", new Classes("CSE121","LR1,LR2,S01","","","4:00-5:30","","4:00-5:30"));
		...
		if(Student.listofcourses.containsKey("MTH2xx")){
			...
			Time_tut.put("MTH2xx", new Classes("MTH2xx","LR1,C23","2:00-3:00","","","","10:30-11:30"));
		}
		if(Student.listofcourses.containsKey("CSE112")){
			Time_Table.put("CSE112", new Classes("CSE112", "C21", " ", " ", "14:30-16:00", "16:00-17:30", " "));
			Time_tut.put("CSE112", new Classes("CSE112","LR3,LR2,C22,C23","","","1:30-2:30","",""));
		...
		if(Student.listofcourses.containsKey("MTH203")){
			...
			Time_tut.put("MTH203", new Classes("MTH203","LR1","8:30-9:30/1:30-3:00","","","",""));
		}
		if(Student.listofcourses.containsKey("ECE250")){
			...
			Time_tut.put("ECE250", new Classes("ECE250","LR3","2:00-3:00","","","",""));
		...
		if(Student.listofcourses.containsKey("MTH2RA")){
			...
			Time_tut.put("MTH2RA", new Classes("ECE250","LR2","1:30-3:00","","","",""));
		}
